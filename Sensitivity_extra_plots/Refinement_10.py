...
def samples():
    ...
    d_gRNAD=pow(10,np.random.uniform(-1.16,1.162))
    k_trD_neg=pow(10,np.random.uniform(0,3.31))
    d_gRNAD_neg=pow(10,np.random.uniform(-1.30,0))
    k_trD_pos=pow(10,np.random.uniform(2.79,5.14))
    k_Dcomplex=pow(10,np.random.uniform(-1.69,0))
    n_SPD=pow(10,np.random.uniform(2.69,3.35))
    n_ND=pow(10,np.random.uniform(1,2))
    K_VD_rel=pow(10,np.random.uniform(1,4.31))
    k_assemblD=pow(10,np.random.uniform(-2,2.31))
    d_N_gRNAD=pow(10,np.random.uniform(-1.16,0))
    k_releaseD=pow(10,np.random.uniform(0.9,4.15))
    ...
    mod_sol=X[[24,48],17]
    distance=np.sqrt(np.sum(pow(mod_sol-_fold_red,2)))
